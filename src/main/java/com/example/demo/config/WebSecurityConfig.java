...
//	        .passwordEncoder(passwordEncoder());
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/login/**","/register/**","/confirm/**","/ws","/topic/messages","/our-websocket","/","/pay","/bills/export","/ajouteretaffecterCartaUser/{iduser}","/addproducttocart/product/{idproduit}/cart/{idcart}/qte/{qte}","/addproducttocart/product/{idproduit}/cart/{idcart}/qte/{qte}","/passercommand/cart/{idc}").permitAll();
        http.authorizeRequests().antMatchers("/user/update-user").permitAll();
